...
- ADR 进度：**13 Accepted（015 含补遗-1/-2）+ 1 Proposed + 2 Reserved**——001/002/003/004/006/007/008/009/010 + 012（lock-visual-quality-anchor，Linear 气质锚定）+ 013（alignment-phrases-tab-inclusion，追认独立 region + Tab cycle 6 tab-reachable）+ 015（expose-mcp-write-pipeline，2026-05-27 Accepted，14 tool + workspace 拆 4 crate + drafts staging；补遗-1 Modifier/Macro field-mapping 决策 iii / 补遗-2 promote 软删 + serde 约束对齐）；005（prompt-combiner 复用）仍 Proposed；011 Reserved（search UsageSource）+ 014 Reserved（nspanel-isa-swizzle）
