...
- 下一动作：**ADR-012 Phase 5 验收已收口**（11/11，2026-06-03 收口 commit；features v0.7 / CLAUDE §7）→ M-X 阶段（MCP 反向写入全链路）+ ADR-012 视觉锚定全链路整体 done。之后并行待办：M0-4 Developer ID 签名 spike + bench 脚本回归；P2 defer：`create_draft` 单写 size-cap（M-X.4）；Claude Design pipeline 待 omar 上传 [[CLAUDE-DESIGN]] 跑 Task β；详见 [[HANDOFF#Next-Actions]]
