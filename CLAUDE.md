...
### 冷区（仅显式查询时取）
- `docs/MANIFEST.md` v1.12 — 项目全文件清单（六层架构总览，AI 进项目读完 CLAUDE.md 接读拿全貌）
