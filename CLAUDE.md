...
- 文档体系：**13 核心 + L5 协作契约 2 + MANIFEST 全部 ratified**（2026-06-11 AE 收尾涟漪：product-spec v0.8 Tab cycle 6→8；前序 spec v0.6 / constitution v1.1 / design-spec v0.8 / prd v0.8 / tech-stack v1.2 / features v1.0；🤝 共创 6/6 ratified）——核心设计文档 `docs/design/01-11-*.md` + L5 派生 [[CLAUDE-DESIGN]] + [[claude-design-prompts]]；全文件清单见 [[MANIFEST]] v1.3
- ADR 进度：**16 Accepted（015 含补遗-1/-2）+ 1 Proposed + 1 Reserved**——001/002/003/004/006/007/008/009/010 + 012（lock-visual-quality-anchor，Linear 气质锚定）+ 013（alignment-phrases-tab-inclusion，追认独立 region + Tab cycle 6 tab-reachable；谱系备注 2026-06-11 AE P2.4 两编辑区入 cycle 6→8）+ 014（nspanel-isa-swizzle，2026-06-03 Reserved→Accepted，NSPanel 子类 override canBecomeKeyWindow + isa-swizzle 取得 borderless key-window 资格）+ 015（expose-mcp-write-pipeline，2026-05-27 Accepted，14 tool + workspace 拆 4 crate + drafts staging；补遗-1 Modifier/Macro field-mapping 决策 iii / 补遗-2 promote 软删 + serde 约束对齐）+ 016（choose-dnd-and-resizable-layout，2026-06-04 Accepted，@dnd-kit/react 0.4 + react-resizable-panels v4）+ 017（enable-auto-update，2026-06-17 Accepted，tauri-plugin-updater + GitHub Releases + Actions 出包，A2 唯一出站豁免）；005（prompt-combiner 复用）仍 Proposed；011 Reserved（search UsageSource）
