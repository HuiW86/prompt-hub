...
|---|---|---|---|---|---|---|
| 搜索区（⌘K 全局搜索） | P0 | `planned` | v1.0 | 0% | omar | [[06-prd#5.0]] |
| 相位带（Phase Bar） | P0 | `planned` | v1.0 | 0% | omar | [[06-prd#5.1]] |
| Macro 快捷区 | P0 | `planned` | v1.0 | 0% | omar | [[06-prd#5.2]] |
| Scene 全景区 | P0 | `planned` | v1.0 | 0% | omar | [[06-prd#5.3]] |
| 最近使用区 | P0 | `planned` | v1.0 | 0% | omar | [[06-prd#5.5]] |
...
|---|---|---|---|---|---|---|
| 全局快捷键注册（默认 ⌥ Space） | P0 | `planned` | v1.0 | 0% | omar | [[prompt-hub-mvp#第一阶段]] |
| 主形态唤起 ≤200ms（P95） | P0 | `planned` | v1.0 | 0% | omar | [[02-constitution#C1]] |
| 复制即隐藏 / ESC 关闭 | P0 | `planned` | v1.0 | 0% | omar | [[prompt-hub-mvp#第一阶段]] |
| UsageRecord 持续记录 | P0 | `planned` | v1.0 | 0% | omar | [[06-prd#6.8]] |
| 三层资产模型（Modifier/Composition/Macro） | P0 | `planned` | v1.0 | 0% | omar | [[02-constitution#B1]] |
| 协议层与任务层物理分离 | P0 | `planned` | v1.0 | 0% | omar | [[02-constitution#B2]] |
| 本地数据存储（无服务端） | P0 | `planned` | v1.0 | 0% | omar | [[02-constitution#A2]] |
| 设计 Token 系统（无裸值） | P0 | `planned` | v1.0 | 0% | omar | [[prompt-hub-mvp#§0-T1]] |
...
- 通过测试: 0 / 0
- 已合并 PR: 0（仅文档 commit）
- 下一动作：见 [[prompt-hub-mvp#§0]] 跨阶段先决条件 + [[09-tech-stack#§3]] 待 ADR 决议项
